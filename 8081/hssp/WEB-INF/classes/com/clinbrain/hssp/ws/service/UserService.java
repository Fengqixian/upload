package com.clinbrain.hssp.ws.service;
...
import com.clinbrain.hssp.common.log.HsspLog;
import com.clinbrain.hssp.common.util.DateUtil;
import com.clinbrain.hssp.ws.dto.ListBean;
import com.clinbrain.hssp.ws.dto.UserInfo;

@Service("userService")
public class UserService {
	
	private final static String className = UserService.class.getName();
	...
	public UserInfo getUserInfo(String userId) {
		HsspLog.show(className, "getUserInfo", "获取userinfo", "获取开始");
