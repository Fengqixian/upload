...
(function ($) {
    ...
    $.dialog = function (options, option2, option3) {
        if (typeof options === 'undefined') options = {};
        if (typeof options === 'string')
            options = {
                content: options,
                title: (option2) ? option2 : false,
                showTime: (option3) ? option3 : 0//添加对话框显示时间长度，若没有则设置为0	--WZQ add
            };
        /*
         *  Alias of jconfirm
         */
    ...
    Jconfirm.prototype = {
        ...
        _bindEvents: function () {
            ...
            /*
             * 如果showTime不为0，则启用延时自动关闭对话框的功能，时间长度为showTime，如果为0，则不启用，由用户负责点击关闭按钮	--WZQ add
             */
            if (this.showTime != 0)
            	{            	
	            	setTimeout(
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm" style="text-align:center;"><div class="jconfirm-bg"></div><div class="jconfirm-scrollpane"><div class="container"><div class="row"><div class="jconfirm-box-container"><div class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1"><div class="closeIcon">&times;</div><div class="title-c"><span class="icon-c"></span><span class="title"></span></div><div class="content-pane"><div class="content" style="text-align:center;font-weight:bold;font-size:23px;"></div></div><div class="buttons"></div><div class="jquery-clear"></div></div></div></div></div></div></div>',
        title: 'Hello',
        content: 'Are you sure to continue?',
        showTime: 0,//添加弹出显示层的显示时间长度	--WZQ add
        contentLoaded: function () {
        },
        icon: '',    
        opacity: 0.35,//调整背景颜色的透明度	--WZQ modified
        confirmButton: 'Okay',
        cancelButton: 'Close',
