...
export default class DragRelationClass {
    constructor({nodes, links, width, height, containerClassName, d3}) {
        /**
         * 每个关系图的节点
         */
        this.nodes = nodes;
    ...
    restart() {
        ...
        _this.circle.selectAll('circle')
            .style('fill', function (d) {
                return (d === _this.selected_node) ? _this.d3['rgb'](_this.colors(d.id)).darker().toString() : "#0e183fe6";
            })
        ...
        g.append('svg:text')
            ...
            .attr('class', 'id')
            .text(function (d) {
                return d.data.nameCn || d.data.nameEn || 'unknown';
            });
