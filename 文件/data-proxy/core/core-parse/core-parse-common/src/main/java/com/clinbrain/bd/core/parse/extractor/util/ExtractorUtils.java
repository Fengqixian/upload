...
package com.clinbrain.bd.core.parse.extractor.util;
...
public final class ExtractorUtils {
     ...
     * @return matched node
     */
    public static ParserRuleContext getFirstChildNode(final ParserRuleContext node, final com.clinbrain.bd.core.parse.extractor.util.RuleName ruleName) {
     ...
     * @return matched node
     */
    public static Optional<ParserRuleContext> findFirstChildNode(final ParserRuleContext node, final com.clinbrain.bd.core.parse.extractor.util.RuleName ruleName) {
     ...
     * @return matched node
     */
    public static Optional<ParserRuleContext> findFirstChildNodeNoneRecursive(final ParserRuleContext node, final com.clinbrain.bd.core.parse.extractor.util.RuleName ruleName) {
     ...
     * @return matched node
     */
    public static Optional<ParserRuleContext> findSingleNodeFromFirstDescendant(final ParserRuleContext node, final com.clinbrain.bd.core.parse.extractor.util.RuleName ruleName) {
     ...
     */
    public static Collection<ParserRuleContext> getAllDescendantNodes(final ParserRuleContext node, final com.clinbrain.bd.core.parse.extractor.util.RuleName ruleName) {
