...
public final class EncryptParseRuleRegistry extends com.clinbrain.bd.core.parse.rule.registry.ParseRuleRegistry {
    
    private static volatile com.clinbrain.bd.core.parse.rule.registry.ParseRuleRegistry instance = new EncryptParseRuleRegistry();
