...
import com.clinbrain.bd.core.parse.rule.jaxb.entity.statement.SQLStatementRuleDefinitionEntity;
...
public final class SQLStatementRuleDefinition {
    ...
    private final Map<String, com.clinbrain.bd.core.parse.rule.registry.statement.SQLStatementRule> rules = new LinkedHashMap<>();
    ...
    public SQLStatementRuleDefinition(final SQLStatementRuleDefinitionEntity entity, final ExtractorRuleDefinition extractorRuleDefinition) {
        for (SQLStatementRuleEntity each : entity.getRules()) {
            rules.put(getContextClassName(each.getContext()), new com.clinbrain.bd.core.parse.rule.registry.statement.SQLStatementRule(each, extractorRuleDefinition));
        }
    }
