...
package com.clinbrain.bd.core.parse.rule.registry.statement;
...
public final class SQLStatementRuleDefinitionTest {
    ...
    public static void setUp() {
        ...
        sqlStatementRuleDefinition = new SQLStatementRuleDefinition(
                new SQLStatementRuleDefinitionEntityLoader().load("META-INF/parsing-rule-definition/sharding/mysql/sql-statement-rule-definition.xml"), 
    ...
    public void assertSelectStatementRule() {
        ...
        assertThat(sqlStatementRule.getSqlStatementClass().getName(), is("com.clinbrain.bd.core.parse.sql.statement.dml.SelectStatement"));
