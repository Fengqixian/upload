...
predicate
    ...
    ;
exprBetween
	: bitExpr NOT? BETWEEN predicate AND predicate;
...
functionCall
    : aggregationFunction | specialFunction_ | regularFunction_ | rownumFunction_
    ;
...
rownumFunction_
    : ROW_NUMBER LP_ RP_ (OVER LP_ partitionByClause orderByClause? RP_)?
    ;
...
regularFunctionName_
    ...
    ;
caseExpression_
    : CASE simpleExpr? caseWhen_+ caseElse_? caseEnd_?
    ;
