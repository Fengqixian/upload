...
package com.clinbrain.bd.shardingproxy.backend.text.sctl;

import com.clinbrain.bd.shardingproxy.backend.text.sctl.exception.InvalidShardingCTLFormatException;
import com.clinbrain.bd.shardingproxy.backend.text.sctl.exception.ShardingCTLException;
import com.clinbrain.bd.shardingproxy.backend.text.sctl.exception.UnsupportedShardingCTLTypeException;
