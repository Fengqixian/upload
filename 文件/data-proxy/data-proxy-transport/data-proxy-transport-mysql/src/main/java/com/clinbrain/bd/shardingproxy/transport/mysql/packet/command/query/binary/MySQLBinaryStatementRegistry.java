...
package com.clinbrain.bd.shardingproxy.transport.mysql.packet.command.query.binary;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import com.clinbrain.bd.shardingproxy.transport.mysql.packet.command.query.binary.MySQLBinaryStatement;
...
public final class MySQLBinaryStatementRegistry {
    ...
    private final ConcurrentMap<Integer, com.clinbrain.bd.shardingproxy.transport.mysql.packet.command.query.binary.MySQLBinaryStatement> binaryStatements = new ConcurrentHashMap<>(65535, 1);
    ...
    public synchronized int register(final String sql, final int parametersCount) {
        ...
        binaryStatements.putIfAbsent(result, new com.clinbrain.bd.shardingproxy.transport.mysql.packet.command.query.binary.MySQLBinaryStatement(sql, parametersCount));
        return result;
    }
     ...
     */
    public com.clinbrain.bd.shardingproxy.transport.mysql.packet.command.query.binary.MySQLBinaryStatement getBinaryStatement(final int statementId) {
