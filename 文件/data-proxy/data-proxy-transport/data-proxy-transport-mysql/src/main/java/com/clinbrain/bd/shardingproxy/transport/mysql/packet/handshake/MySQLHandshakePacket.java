...
package com.clinbrain.bd.shardingproxy.transport.mysql.packet.handshake;

import com.google.common.base.Preconditions;
import lombok.Getter;
import com.clinbrain.bd.shardingproxy.transport.mysql.constant.MySQLCapabilityFlag;
import com.clinbrain.bd.shardingproxy.transport.mysql.constant.MySQLServerInfo;
import com.clinbrain.bd.shardingproxy.transport.mysql.constant.MySQLStatusFlag;
import com.clinbrain.bd.shardingproxy.transport.mysql.packet.MySQLPacket;
import com.clinbrain.bd.shardingproxy.transport.mysql.packet.handshake.MySQLAuthPluginData;
...
public final class MySQLHandshakePacket implements MySQLPacket {
    ...
    @Getter
    private final com.clinbrain.bd.shardingproxy.transport.mysql.packet.handshake.MySQLAuthPluginData authPluginData;
    
    public MySQLHandshakePacket(final int connectionId, final com.clinbrain.bd.shardingproxy.transport.mysql.packet.handshake.MySQLAuthPluginData authPluginData) {
