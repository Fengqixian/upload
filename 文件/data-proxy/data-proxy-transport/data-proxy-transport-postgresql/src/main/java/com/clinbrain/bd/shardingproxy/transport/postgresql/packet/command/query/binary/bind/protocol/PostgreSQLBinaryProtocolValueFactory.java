...
package com.clinbrain.bd.shardingproxy.transport.postgresql.packet.command.query.binary.bind.protocol;
...
public final class PostgreSQLBinaryProtocolValueFactory {
    ...
    static {
        ...
        setStringCharBinaryProtocolValue();
    }
    ...
    private static void setStringCharBinaryProtocolValue() {
        PostgreSQLStringBinaryProtocolValue binaryProtocolValue = new PostgreSQLStringBinaryProtocolValue();
