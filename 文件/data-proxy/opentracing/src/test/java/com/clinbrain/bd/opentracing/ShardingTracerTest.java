...
package com.clinbrain.bd.opentracing;
...
import com.clinbrain.bd.opentracing.fixture.FooTracer;
...
public final class ShardingTracerTest {
    ...
    @Before
    public void setUp() {
        System.setProperty("com.clinbrain.bd.opentracing.tracer.class", FooTracer.class.getName());
        clearGlobalTracer();
    }
    
    @After
    public void tearDown() {
        System.getProperties().remove("com.clinbrain.bd.opentracing.tracer.class");
    }
    ...
    public void assertTracerClassError() {
        System.setProperty("com.clinbrain.bd.opentracing.tracer.class", "com.foo.FooTracer");
        ShardingTracer.init();
    }
