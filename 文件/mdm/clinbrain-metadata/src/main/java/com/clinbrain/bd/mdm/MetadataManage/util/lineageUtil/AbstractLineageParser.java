 ...
 * @param <T>
 */
public abstract class AbstractLineageParser<T> extends Thread{
    protected final static Logger LOGGER = LoggerFactory.getLogger(AbstractLineageParser.class);
    /**
     * 解析器的运行环境
     */
    protected volatile ParseLineageAbstractEnviroment enviroment;
    /**
     * 解析器当前解析对象
     */
    protected T parsingObject;

    public void init(ParseLineageAbstractEnviroment enviroment, String name){
        this.setName(name);
