...
public class MD5Util {
    ...
    public static String encode(String value) {
        try {
            ...
            md.update(value.getBytes());//此处传入要加密的byte类型值
            ...
            */
            ...
            return sb.toString().substring(0, sb.length()).toUpperCase();//从下标0开始，length目的是截取多少长度的值
    ...
    public static void main(String[] args) {
       System.out.println(MD5Util.encode("ASDFASFASF"));
    }
}
